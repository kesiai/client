...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: 查看 GitHub
      link: https://github.com/sshwsfc/kesi-client
...
```typescript
import { createAPI, setConfig } from '@kesi/client'
...
```typescript
import { SchemaForm, setFormFields, setSchemaConverters } from '@kesi/client'
...
- [贡献指南](https://github.com/kesi/client/blob/main/CONTRIBUTING.md) - 参与项目贡献
