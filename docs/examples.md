...
```typescript
import { Model, useModelList, useModelPermission, useModelPagination, useModelPageSize, useModelSelect, useModelDelete } from '@kesi/client'
...
```typescript
import { Model, useModelGet, useModelSave } from '@kesi/client'
